...
$string['eventgradereportviewed'] = 'Morozov report viewed';
$string['morozov:manage'] = 'Manage the morozov report';
$string['morozov:view'] = 'View the morozov report';
$string['pluginname'] = 'Morozov report';
$string['preferences'] = 'Morozov report preferences';
